    ...
    return (
        <div className="rightpart w-full h-full">
            <div className="h-full flex flex-col overflow-hidden">
                <div className="selfProfilePart flex-1 overflow-y-auto">
                    <div className="topright flex border-[1px] rounded-md w-full h-72"
                        ...
                        <div className="flex col-start-1 col-end-4 row-start-1 row-end-5 items-center justify-center border-b-[1px] border-r-[1px]">
