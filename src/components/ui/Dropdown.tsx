...
function Dropdown({ Setquantity, quntity, fields, nameDrop }: DropdownProps) {
    ...
    return (
        <div>
            <select
                id="product"
                className="block appearance-none w-full h-11 focus:border-blue-300 bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
