...
export function LampDemo({ children }: PropsWithChildren<{}>) {
  return (
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
